...
export async function POST(req: Request) {
  ...
  try {
    const { nom, description, stock, prix, image_url, category_id } = await req.json();
    ...
    await db.query(
      "INSERT INTO produits (nom, description, stock, prix, image_url, category_id) VALUES (?, ?, ?, ?, ?, ?)",
      [nom, description, stock, prix, image_url, category_id]
    );

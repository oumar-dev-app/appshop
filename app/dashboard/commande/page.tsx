...
export default function CommandePage() {
    ...
    const handleDelete = async (id: number) => {
        if (!confirm("Voulez-vous vraiment supprimer ce commande ?")) {
            return;
        }
        ...
        try {
            ...
            toast.success(data.message || "Commandes supprimé");
        } catch (error: any) {
            toast.dismiss(loadingToast);
            toast.error(
            ...
            <div className="max-w-7xl mx-auto mt-4 mb-2 py-4 px-4 sm:px-6 text-black">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mt-4">
                    <Card
                        ...
                        value={`${formatFCFA(stats.totalPrice ?? 0).toLocaleString()} FCFA`}
                    />
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between mb-6 mt-10">
                    ...
                    <div className="relative w-full sm:w-1/2">
                        ...
                        <input
                            ...
                            className="w-full border border-white rounded bg-white pl-10 pr-3 py-2 shadow-lg outline-none focus:border-green-500 transition"
                        />
                    </div>
                            ...
                            <table className="w-full border-collapse">
                                ...
                                <tbody>
                                    {filteredCommandes.map((commande) => (
                                        <tr
                                            key={commande.id}
                                            className="border-b border-gray-700 hover:bg-gray-800 text-black"
                                        >
                                            ...
                                            <td className="p-3 font-semibold">
                                                {formatFCFA(commande.total.toLocaleString())}
                                            </td>

                                            <td className="p-3">
                                                <span
                                                    className={`px-2 py-1 rounded text-sm ${commande.status === "pending"
                                            ...
                                            <td className="p-3">
                                                <span
                                                    className={`px-2 py-1 rounded text-sm ${commande.mode_commande === "livraison"
...
function Card({
    ...
    return (
        <div className="border border-white border-b-green-400 border-b-3 bg-white text-black shadow-lg p-4 rounded-lg">
